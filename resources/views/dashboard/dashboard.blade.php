...
@section('content')
    ...
    <div class="section mt-2" id="presence-section">
                        ...
                        <div class="card-body">
                            <div class="presencecontent">
                                ...
                                <div class="presencedetail">
                                    ...
                                    <span>
                                        {{ $presensiHariIni != null ? (new DateTime($presensiHariIni->jam_in))->format('H:i:s') : 'Belum absen' }}
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="presencecontent">
                                ...
                                <div class="presencedetail">
                                    ...
                                    <span>
                                        {{ $presensiHariIni != null && $presensiHariIni->jam_out !== null ? (new DateTime($presensiHariIni->jam_out))->format('H:i:s') : 'Belum absen' }}
                                    </span>
                                </div>
                            </div>
                        </div>
        ...
        <div id="rekapabsen">
            <h3>Rekap Presensi {{ $namaBulan[$currMonth] }} {{ $currYear }}</h3>
            <div class="row">
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 16px 12px; !important; line-height: 0.8rem;">
                            <span class="badge bg-danger" style="position: absolute; top:3px; right:10px; font-size:0.6rem; z-index: 999">25</span>
                            ...
                            <li>
                                <div class="item">
                                    ...
                                    <div class="in">
                                        ...
                                        <span class="badge badge-success">{{ date('H:i:s', strtotime($item->jam_in)) }}</span>
                                        <span class="badge badge-warning">{{ $presensiHariIni != null && $item->jam_out != null ? date('H:i:s', strtotime($item->jam_out)) : 'Belum Absen' }}</span>
                                    </div>
                                </div>
                            </li>
                        @endforeach
